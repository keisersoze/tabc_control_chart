...
Cond.RL.Lepage = function(m, n, crit = "ARL0", p = 0.5, UCLs = seq(2, qchisq(0.9999, 2), 0.5), w = 5000, force.w = FALSE, seed.no = 17031861){
  set.seed(seed.no)
  ...
  z = as.numeric(vapply(1:w, function(i){Tabc.pvalue.log (Phase1sample,rnorm(n),"less", 1000)}, FUN.VALUE = numeric(1)))
...
print(UCL.Lepage(100, 5, UCLs=seq(1, 5, 1 ), sim = 100, w = 2000))
