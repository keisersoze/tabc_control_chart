...
//    Rcpp::Rcout << tc_obs << std::endl;
    ...
    Rcpp::Rcout << ta_perm << std::endl;
    Rcpp::Rcout << tb_perm << std::endl;
    Rcpp::Rcout << tc_perm << std::endl;

    double pa_obs = Rcpp::sum(Rcpp::ifelse( ta_perm <= ta_obs, 1, 0))/B;
    double pb_obs = Rcpp::sum(Rcpp::ifelse( tb_perm <= tb_obs, 1, 0))/B;
    double pc_obs = Rcpp::sum(Rcpp::ifelse( tc_perm <= tc_obs, 1, 0))/B;
