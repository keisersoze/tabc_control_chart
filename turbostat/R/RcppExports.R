...
calibrate.unconditional <- function(m, n, distribution_key, distribution_parameters, monitoring_statistic_key, monitoring_statistic_parameters, limits_seq, is_upper_limit, nsim, run_length_cap) {
    .Call(`_turbostat_calibrate_unconditional`, m, n, distribution_key, distribution_parameters, monitoring_statistic_key, monitoring_statistic_parameters, limits_seq, is_upper_limit, nsim, run_length_cap)
}
...
evaluate.conditional <- function(reference_sample, n, limit, is_upper_limit, shifts, monitoring_statistic_key, monitoring_statistic_parameters, nsim, run_length_cap) {
    .Call(`_turbostat_evaluate_conditional`, reference_sample, n, limit, is_upper_limit, shifts, monitoring_statistic_key, monitoring_statistic_parameters, nsim, run_length_cap)
}
...
compute_permutation_distribution <- function(statistic, m, n, n_perm) {
    .Call(`_turbostat_compute_permutation_distribution_r`, statistic, m, n, n_perm)
}
...
#' @export
turbostat.setseed <- function(seed) {
    invisible(.Call(`_turbostat_set_seed`, seed))
}
...
test.t_due_e_mezzo <- function(n) {
    .Call(`_turbostat_test_t_due_e_mezzo`, n)
}

test.laplace <- function(n, location, scale) {
    .Call(`_turbostat_test_laplace`, n, location, scale)
}

test.cauchy <- function(n, location, scale) {
    .Call(`_turbostat_test_cauchy`, n, location, scale)
}

test.standard_half_cauchy <- function(n) {
    .Call(`_turbostat_test_standard_half_cauchy`, n)
}

test1 <- function(n) {
    .Call(`_turbostat_test1`, n)
}

test.ansari_bradley <- function(x1, x2) {
    .Call(`_turbostat_test_ansari_bradley`, x1, x2)
}

test.difference_of_means_klotz <- function(x1, x2) {
    .Call(`_turbostat_test_difference_of_means_klotz`, x1, x2)
}

test.lepage <- function(x1, x2) {
    .Call(`_turbostat_test_lepage`, x1, x2)
}
